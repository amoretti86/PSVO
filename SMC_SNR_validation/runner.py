...
def main(_):
    ...
    SNR_NP_list = [int(x) for x in FLAGS.SNR_NP_list.split(",")]
    SNR_collect_grads_points = [int(x) for x in FLAGS.SNR_collect_grads_points.split(",")]
    ...
    mytrainer.set_epoch_data_saving(RLT_DIR, save_trajectory, save_y_hat, save_gradient, saving_num,
                                    SNR_sample_num, SNR_NP_list, SNR_collect_grads_points)
